...
filterDate : function(oEvent){
    var iChar, sChar, iCarret, sNumChar, aFormats, aValues, iCur, iStartPos, sCur, sDateFormat = this.getWebApp().psDateFormat, sDateSepp = this.getWebApp().psDateSeparator;
...
filterNumeric : function(oEvent){
    var iChar, sValidChars, sChar, iSeparator, iBefore, iDecimals, iMaxBefore, iPos, sValue, iSel, sDecSepp = this.getWebApp().psDecimalSeparator;
