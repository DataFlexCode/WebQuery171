...
set_pbShowBorder : function(bVal){
    if(this._eControl){
        df.dom.toggleClass(this._eControl, "WebCC_BodyBorder", bVal);
        df.dom.toggleClass(this._eControl, "WebCC_BodyNoBorder", !bVal);
...
set_pbShowCaption : function(bVal){
    if(this._eLabel){
        ...
        df.dom.toggleClass(this._eControl, "WebCC_HasCaption", bVal);
