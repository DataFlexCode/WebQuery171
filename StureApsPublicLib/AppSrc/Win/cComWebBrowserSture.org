...
Class cComWebBrowserSture is a cComWebBrowser
    ...
    Procedure HistoryCurrent 
        ...
        Send HandleDirectLinkNavigation (_HistoryAtIndex(Self,_piHistoryPointer(Self)))
    End_Procedure
    Procedure HistoryPrevious 
        Set _pbHistoryInProgress to True
        Send HandleDirectLinkNavigation (_HistoryAtIndex(Self,_piHistoryPointer(Self)-1))
    End_Procedure
    ...
    Procedure HistoryFirst 
        Set _pbHistoryInProgress to True
        Send HandleDirectLinkNavigation (_HistoryAtIndex(Self,0))
    End_Procedure
    Procedure HistoryLast 
        Set _pbHistoryInProgress to True
        Send HandleDirectLinkNavigation (_HistoryAtIndex(Self,999999))
    End_Procedure
    Procedure HistoryAppend tHTMLDirectLink strNewCurrent
        tHTMLDirectLink[] aHistory
        If (_pbHistoryInProgress(Self)) Begin
    ...
    Procedure GotoPage String sPage String sAction
        Integer hPageObject
...
//    //> the message to here by calling the HandleDirectLinkNavigation method.
    ...
    Function FindDirectLinkRecord tHTMLDirectLink strDirectLink Returns Boolean
        ...
        If (strDirectLink.iTable<>0) Begin
            Get FindRecordByLID of oHTMLDirectLinkFunctions strDirectLink.iTable strDirectLink.sRowID to bFound
        End
        Else Begin
    ...
    Procedure HandleDirectLinkNavigation tHTMLDirectLink strDirectLink
        ...
        If (strDirectLink.sPage<>"") Begin
            Send GotoPage strDirectLink.sPage strDirectLink.sFlavour
